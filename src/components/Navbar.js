    ...
    <>
      <div className="header">
        ...
        <div className="search">
          <input
            type="text"
            placeholder="try sarri kurti,or search by product code"
        ...
        <div>
          {/* <Avatar/> */}
          <Link to="/login">
            <h3 className="profileAndCart">Profile</h3>
          </Link>
        </div>
      ...
      <nav>
        <ul>
          ...
          <li>
            Kids
            <div className="subMenu">
              <div id="kids" className="submenuList"></div>
            </div>
          </li>
          <li>
            Home & Kitchen
          ...
          <li>
            ...
            <div className="subMenu">
              <div id="JewelleryAndAccessories" className="submenuList"></div>
            </div>
          </li>
          <li>
            Bags & Footwear
            <div className="subMenu">
              <div id="BagsFootWarId" className="submenuList"></div>
            </div>
          </li>
          <li>
            Electronics
            <div className="subMenu">
              <div id="ElectronicsId" className="submenuList"></div>
            </div>
          </li>
        </ul>
      </nav>
        ...
        <div class="lowestPrice_text">
          ...
          <div class="lowestPriceWhay">
            <div class="lowestPriceItem">
              <div class="lowestPrice_icon"></div>
              <p>Free Delivery</p>
            </div>
